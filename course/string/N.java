...
public class N {
    ...
    private void solve() {
        ...
        Point answer = getAnswer(s, t);
        out.println(answer.x + " " + answer.y);
    }
    ...
    Point getAnswer(char[] s, char[] t) {
        ...
        for (int i = 0; i < t.length; ++i) {
            ...
            char ch = t[i];
            char revCh = Character.isLowerCase(ch)
        ...
        return new Point(sameCase, otherCase);
    }
